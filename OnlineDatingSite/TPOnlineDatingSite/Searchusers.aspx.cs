        ...
        public void ReadInfo(Findprofile findprofile)
        {
...

            {
              ...
              /*  sb.Append("<div class=\"modal-footer\">")*/;
                //sb.Append("<a href=\"LikeDisLike.aspx?_userTo=" + username + "&value=1" + "\"class=\"btn btn-success btn-sm fas fa-heart fa-2x\"></a>" + "<a href=\"LikeDisLike.aspx?_userTo=" + username + "&value=0" + "\"class=\"btn btn-danger btn-sm fas fa-times fa-2x\"></a>" +
                    //"<a href=\"MemberHomeView.aspx?_id=" + username + "\"class=\"btn btn-info btn-sm fas fa-eye fa-2x\"></a>");
                sb.Append("</div>");
