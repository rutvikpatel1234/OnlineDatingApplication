...
namespace Utilities
{
    public class Email
    {
        ...
        public string SendEmail(String recipient, String sender, String subject, String body, String cc = "", String bcc = "")
        {
            try
            {
                ...
                //mailMessage.Subject = messageBody;
                SmtpClient smtpClient = new SmtpClient("smtp.gmail.com");
                objMail.From = new MailAddress("termproject2020@gmail.com");
                objMail.To.Add("termproject2020@gmail.com");
                objMail.Subject = subject;
                objMail.Body = messageBody;
                smtpClient.Port = 587;
                smtpClient.Credentials = new System.Net.NetworkCredential("termproject2020@gmail.com", "Admintp20");
